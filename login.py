...
def login():
    ...
    elif usernameEntry.get() == 'Pawan' and passwordEntry.get() == '12345':
...
logoLabel.grid(row=0,column=0,columnspan=2,pady=10,padx=15)
...
loginButton=Button(loginFrame,text='Login',font=('times new roman',20,'bold'),width=10,fg='white',bg='cornflowerblue'
